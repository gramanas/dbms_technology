...
// There are 3 dummy fields that you can use for your needs.
typedef struct {
    unsigned int recid;
    unsigned int num;
    char str[STR_LENGTH];
    bool valid;  // if set, then this record is valid
    unsigned int rdummy1;
    unsigned int rdummy2;
    unsigned int rdummy3;
} record_t;
...
typedef struct {
    ...
    unsigned char misc;
    unsigned int bdummy1;
    unsigned int bdummy2;
    unsigned int bdummy3;
} block_t;
